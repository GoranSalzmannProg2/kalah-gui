...
public interface Board extends Cloneable {
     ...
     *                                  grid.
     */
    de.uni_passau.fim.prog2.kalah.model.Board move(int pit);
     ...
     *                              prematurely.
     */
    de.uni_passau.fim.prog2.kalah.model.Board machineMove()
     ...
     * @return A clone.
     */
    de.uni_passau.fim.prog2.kalah.model.Board clone();
